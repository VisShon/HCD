...
export default function PeopleSection({content}){
    ...
    return(
        <div className={"peopleSection "+content.CSSclassName}>
            ...
            <div className='flex  items-center  absolute z-0 font-Archivo text-[#ffffff] text-[8vw] bottom-0 my-10 conti small:items-start'>
                <span className='mx-10'>
                    {content.stat}
                </span>
                <span className='font-Maven  text-[1.5rem] max-w-[40%] mx-10 my-10  small:max-w-[100%] small:my-0'>
                    {content.description}
                </span>
            </div>
        </div>
